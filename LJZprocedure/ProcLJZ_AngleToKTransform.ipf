...
Function a2k1d_cleanup_output_temp(dryRun)
    Variable dryRun
    ...
    if (dryRun)
        Print "DryRun: would clear temporary plotting waves under " + outDF
        return 0
    endif
